...
class MessageRepositoryTest {
    ...
    void testFindByRoomIdOrderByCreatedAtDesc_Success() {
        ...
        when(messageRepository.findByRoomIdOrderByCreatedAtDesc(1L, any(Pageable.class)))
                .thenReturn(Arrays.asList(msg2, msg1));

        List<Message> result = messageRepository.findByRoomIdOrderByCreatedAtDesc(1L, any(Pageable.class));
    ...
    void testFindByRoomIdOrderByCreatedAtDesc_EmptyList() {
        when(messageRepository.findByRoomIdOrderByCreatedAtDesc(999L, any(Pageable.class)))
                .thenReturn(Arrays.asList());

        List<Message> result = messageRepository.findByRoomIdOrderByCreatedAtDesc(999L, any(Pageable.class));
